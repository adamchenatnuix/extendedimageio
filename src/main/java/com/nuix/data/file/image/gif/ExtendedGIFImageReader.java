...
/**
 * GIF image reader with fix for https://bugs.openjdk.org/browse/JDK-7132728.
 */
public class ExtendedGIFImageReader extends ImageReader {
    ...
    public ExtendedGIFImageReader(ImageReaderSpi originatingProvider) {
    ...
    private void readHeader() throws IIOException {
        ...
        try {
            ...
            String version = String.valueOf((char) signature[3]) +
                    (char) signature[4] +
                    (char) signature[5];
    ...
    private void readMetadata() throws IIOException {
        ...
        try {
            ...
            imageMetadata = new GIFImageMetadata();
    ...
    public BufferedImage read(int imageIndex, ImageReadParam param)
        ...
        destinationOffset = new Point(destinationRegion.x,
                destinationRegion.y);
        ...
        try {
            ...
            if (initCodeSize < 1 || initCodeSize > 8) {
                throw new IIOException("Bad code size:" + initCodeSize);
            }
